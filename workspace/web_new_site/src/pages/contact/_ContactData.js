                ...
                <Grid container columns={9}>
                    ...
                    <Grid sx={{p: 2}} size={{md: 6, xs: 9}}>
                        ...
                        <div>
                            ...
                            <Typography variant={"caption"} sx={{fontSize: "1rem", lineHeight: "2rem", fontWeight: 400}}> تهران - نارمک
                                جنوبی - پلاک ۴۱۶ </Typography>
                        </div>
                        <div>
                            <Typography variant={"caption"} sx={{fontSize: "1rem", lineHeight: "2rem", fontWeight: 600}}>تماس با جیم پین
                                :</Typography>
                        </div>
                        <div>
                        ...
                        <div>
                            <Typography variant={"caption"} sx={{fontSize: "1rem", lineHeight: "2rem", fontWeight: 600}}>ایمیل
                                :</Typography>
                            <Typography variant={"caption"}
                                        sx={{fontSize: "1rem", lineHeight: "2rem", fontWeight: 400}}> info@gympin.ir</Typography>
                        </div>
                        <Typography variant={"h3"} sx={{fontSize: "1.3rem", fontWeight: 600, mt: 4, mb: 1}}>رسانه‌ها :</Typography>
                        <div>
                            <Typography variant={"subtitle1"} sx={{fontSize: "1rem", fontWeight: 400}}>ما را در رسانه‌های اجتماعی دنبال کنید
                                تا</Typography>
                            <Typography variant={"subtitle1"} sx={{fontSize: "1rem", fontWeight: 400}}>از آخرین اخبار و رویدادها باخبر شوید
                                :</Typography>
