        ...
        <section  >
            <Container>
                <Grid sx={{pb:12,pt:12}} container columns={16} alignContent={"center"} textAlign={"center"} justifyItems={"center"}>
                    ...
                    <__SingleGoal Aos={"fade-left"} image={"/assets/images/save-money.svg"} title={"حفظ بودجه سازمان"} text={"بر خلاف روش‌های سنتی، بودجه پرداختی سازمان به جیم پین، در صورت عدم استفاده کارمندان، از بین نرفته و قابل اعتبار دهی مجدد است."} alt={"رفاهیات پرسنلی"} />
