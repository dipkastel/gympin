        ...
        <section>
            <Container>
                <Grid sx={{mb: 8,mt:12}} container columns={6}  >
                    ...
                    <SportItem size={{xs: 3, sm: 3, md: 2,xl:2}} image={"/assets/images/toopi.jpg"} alt={"ورزش‌های گروهی و تیمی"} title={"ورزش‌های گروهی"} text={"با ورزش های گروهی احساس تعامل و همکاری در گروه‌ها بیشتر شده و در کار های گروهی موفقیت بیشتری به دست می آورند."}/>
                </Grid>
            </Container>
        </section>
    );
