        ...
        <section>
            <Container>
                <Grid sx={{mb: 8,mt:12}} container columns={6}  >
                    <SportItem size={{xs: 3, sm: 3, md: 2,xl:2}} image={"/assets/images/estakhr.jpg"} alt={"ورزش‌های آبی که برای کارمندان ایجاد نشاط می‌کند"} title={"ورزش‌های آبی"} text={"قدرت و شادابی را در دل آب پیدا کنید! با ورزش‌های آبی، تغییرات مثبت را در بدن و ذهن خود تجربه کنید و به بهترین نسخه از خود تبدیل شوید."}/>
                    <SportItem size={{xs: 3, sm: 3, md: 2,xl:2}} image={"/assets/images/bodybuilding.jpg"} alt={"ورزش‌هایی که برای عموم مردم جذاب است"} title={"باشگاه‌های بدنسازی"} text={"هر بار که به باشگاه می‌آیید، یک قدم به هدف‌های خود نزدیک‌تر می‌شوید! با جیم پین، هر تمرین فرصتی برای تغییر و تحول است."}/>
                    <SportItem size={{xs: 3, sm: 3, md: 2,xl:2}} image={"/assets/images/shamshir.jpg"} alt={"پدل برد ورزش مورد علاقه مدیران"} title={"ورزش‌های رزمی"} text={"آماده‌اید تا مرزهای خود را بشکنید؟ با ورزش‌های رزمی جیم پین، هر جلسه تمرین فرصتی برای ارتقاء مهارت‌ها و تقویت روحیه‌تان است."}/>
                    ...
                    <SportItem size={{xs: 3, sm: 3, md: 2,xl:2}} image={"/assets/images/toopi.jpg"} alt={"ورزش‌های گروهی و تیمی"} title={"ورزش های کروهی"} text={"با ورزش های گروهی احساس تعامل و همکاری در گروه ها بیشتر شده و در کار های گروهی موفقیت بیشتری به دست می آورند."}/>
                </Grid>
            </Container>
        </section>
    );
