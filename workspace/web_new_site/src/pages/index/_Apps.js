            ...
            <Container>
                ...
                <Grid container sx={{direction: "ltr"}} columns={4} alignContent={"center"} textAlign={"right"}>
                    ...
                    <Grid sx={{px: 6, direction: "rtl"}} item size={{md: 2, xs: 4}}>
                        ...
                        <Typography sx={{fontWeight: 400, mt: 2, mb: 0,lineHeight:2, textAlign: "justify"}} variant={"subtitle2"}>با استفاده از قابلیت
                        ...
                        <Typography sx={{fontWeight: 400, mt: 0, mb: 3,lineHeight:2, textAlign: "justify"}} variant={"subtitle2"}>مشاهده ی فعالیت‌های
                            کارمندان بر روی پنل،
                ...
                <Grid container columns={4} alignContent={"center"} textAlign={"right"}>
                    ...
                    <Grid sx={{px: 6}} item size={{md: 2, xs: 4}}>
                        ...
                        <Typography sx={{fontWeight: 400, mt: 2, mb: 3,lineHeight:2, textAlign: "justify"}} variant={"subtitle2"}>اپلیکیشن کارمندان یک
                ...
                <Grid container sx={{direction: "ltr"}} columns={4} alignContent={"center"} textAlign={"right"}>
                    ...
                    <Grid sx={{px: 6, direction: "rtl"}} item size={{md: 2, xs: 4}}>
                        ...
                        <Typography sx={{fontWeight: 400, mt: 2, mb: 1,lineHeight:2, textAlign: "justify"}} variant={"subtitle2"}>پنل اختصاصی مراکز ورزشی
                            ...
                            باشد.</Typography>
                        <Typography sx={{fontWeight: 400, mt: 1, mb: 3,lineHeight:2, textAlign: "justify"}} variant={"subtitle2"}>مراکز ورزشی از طریق
