        ...
        <>
            <Collapse in={true}  data-aos="fade-left" >
                ...
                <Typography variant={"body2"} sx={{fontWeight: 500, mt: 4, lineHeight: 2, textAlign: "justify"}}>جیم پین در حوزه رفاهیات
                    پرسنل، به طور اختصاصی ورزش و سلامت کارمندان فعالیت می‌کند و پل ارتباطی شرکت‌ها و مراکز ورزشی است. جیم پین با شبکه گسترده ای از مراکز ورزشی همکاری می‌کند تا کارمندان شرکت‌های طرف قرارداد، در هر نقطه از شهر به مراکز
