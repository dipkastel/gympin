        ...
        <>
            <Collapse in={true}>
                ...
                <Typography variant={"body2"} sx={{fontWeight: 500, mt: 4, lineHeight: 1.4, textAlign: "justify"}}>«جیم پین» در حوزه رفاهیات
                    پرسنل، به طور اختصاصی ورزش و سلامت کارمندان فعالیت می کند و پل ارتباطی شرکت ها و مراکز ورزشی است. «جیم پین»
                    به نمایندگی از طرف سازمان ها، با تعداد زیادی مجموعه ی ورزشی در سراسر استان تهران و البرز همکاری می کند تا کارمندان شرکت
                    های طرف قرارداد، در هر نقطه از شهر به مراکز ورزشی دسترسی ارزان و آسان داشته باشند؛ این مراکز ورزشی دارای پراکندگی محاسبه
                    شده بر روی نقشه و همچنین رشته های بسیار متنوع هستند.</Typography>
            ...
            <Collapse in={thisFormStatus===formStatus.complete}>
                <Alert sx={{mt:3}} elevation={10} variant={"filled"} severity={"success"} >با تشکر از شما. همکاران ما به زودی با شما تماس خواهند گرفت.</Alert>
            </Collapse>
            <Collapse in={thisFormStatus===formStatus.error}>
                <Alert sx={{mt:3}} elevation={10} variant={"filled"} severity={"error"} >خطا در ارسال اطلاعات . لطفا با شماره های جیم پین تماس بگیرید!</Alert>
            </Collapse>
            <Collapse in={thisFormStatus!==formStatus.complete}>
