                ...
                <Grid >
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-12">
                                <h4 className="privacy__heading mt-30 mb-20">خدمات گوگل</h4>
                                <p>ما در جیم پین از سرویس تجریه و تحلیل گوگل ااستفاده می کنیم برای مشاهده قوانین گوگل به لینک زیر مراجعه نمایید:</p>
                                <a href={"https://www.google.com/policies/privacy/partners"}>www.google.com/policies/privacy/partners</a>
                                <p>و یا</p>
                                <a href={"https://www.google.com/analytics/policies"}>Google Analytics Policies</a>
                            </div>
                            <br/>
                            <br/>
                            <br/>
