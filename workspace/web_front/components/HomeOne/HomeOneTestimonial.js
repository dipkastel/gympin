...
export default function HomeOneTestimonial() {
    const team = [
        {
            text:"من تا الان هفته ای 2 روز ورزش میکردم چون ورزش کردن من نیاز داشت حتما نزدیک حونه باشم تا بتونم برمباشگاه از وفتی با جیم پین آشنا شدم ساک باشگاه پشت ماشینمه و فقط کافیه 2 ساعت وقت خالی پیدا کنم هرجا باشم یه باشگاه نزدیکپیدا میکنم و تموم.ورزش کردن برام مثل آب خوردن شده اصلا فکرشم نمی کردم همچین چیزی امکان پذیر باشه دمتون گرم",
