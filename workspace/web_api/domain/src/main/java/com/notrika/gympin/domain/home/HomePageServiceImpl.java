package com.notrika.gympin.domain.home;
...
import com.notrika.gympin.persistence.dao.repository.home.HomePageRepository;
import com.notrika.gympin.persistence.dao.repository.home.HomePageTypesRepository;
...
public class HomePageServiceImpl extends AbstractBaseService<HomePageItemParam, HomePageDeadendDto, HomePageQuery, HomePageItemEntity> implements HomePageService {
    ...
    public HomePageDeadendDto update(HomePageItemParam homePageParam) {
        ...
        if(homePageParam.getDestination()!=null)
