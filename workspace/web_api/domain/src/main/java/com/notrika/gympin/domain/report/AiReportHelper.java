...
public class AiReportHelper {
    ...
    private String getFourthLine() {
        return "میانگین زمان حضور کاربران در  وب اپلیکیشن جیم پین، 9 دقیقه به ازای هر نفر بوده که کارمندان در این مدت به بررسی مراکز ورزشی طرف قرارداد پرداخته اند و بیشترین آمار جستجو مربوط به رشته های ماساژ، چربی سوزی و فیتنس بوده است.";
    }
