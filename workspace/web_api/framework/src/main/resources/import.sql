...
# sms patterns
    ...
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (1,'پترن کد ورود - فراز sms','FARAZ_SMS_PATTERN_SENDCODE','nlvhqg68mg','%code% کد تایید شما gympin.ir',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (2,'پترن درخواست عضویت - فراز sms','FARAZ_SMS_PATTERN_JOINREQUEST','4m6dd8bc1k26dxf','درخواست شما برای ثبت مرکز ورزشی %place% در جیم پین دریافت شد. به زودی همکاران ما با شما تماس خواهند گرفت.',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (3,'پترن عضویت پرسنل مجموعه - فراز sms','FARAZ_SMS_PATTERN_JOINTOPLACE','75tum3ve8b1lxhq','شماره شما به عنوان %role% مرکز ورزشی %place% در اپلیکیشن جیم پین ثبت شده است. اکنون می توانید از امکانات اپلیکیشن مراکز جیم پین استفاده کنید https://place.gympin.ir',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (4,'پترن عضویت در سازمان - فراز sms','FARAZ_SMS_PATTERN_JOINTOCORPORATE','ipn2tr1uoz9dn49','شماره شما به عنوان پرسنل  %corporate% در اپلیکیشن جیم پین ثبت شده است. اکنون می توانید از امکانات اپلیکیشن جیم پین استفاده کنید https://gympin.ir',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (5,'پترن کم بود شارژ سازمان - فراز sms','FARAZ_SMS_PATTERN_LOWBUDGET_CORPORATE','ch6j8p5ziy29ats','مدیر %corporate% گرامی شارژ شما در اپلیکیشن جیم پین رو به اتمام است برای جلوگیری از عدم دسترسی کاربران به اعتبارهای اهدایی ، نسبت به افزایش شارژ خود اقدام نمایید. corporate.gympin.ir/finance',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (6,'پترن شارژ موفق کاربر - فراز sms','FARAZ_SMS_PATTERN_USER_CHARGE','ffdn7qlz485gpt2','پرداخت با موفقیت انجام شد. اعتبار شما به مبلغ %amount% تومان در اپلیکیشن جیم پین افزایش یافت. web.gympin.ir/wallet',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (7,'پترن شارژ موفق سازمان - فراز sms','FARAZ_SMS_PATTERN_CORPORATE_CHARGE','k0pyzc0atwmqiy8','پرداخت با موفقیت انجام شد. اعتبار سازمان شما به مبلغ %amount% تومان در اپلیکیشن جیم پین افزایش یافت. corporate.gympin.ir/finance',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (8,'پترن خرید عضویت - فراز sms','FARAZ_SMS_PATTERN_USER_BUY_SUBSCRIBE','zn9ewsfhggm48od','عضویت %subscribe-name% از مجموعه %place-name% در اپلیکیشن جیم پین توسط شما خریداری شد. مشاهده خرید ها : web.gympin.ir/subscribes',10,0);
    INSERT INTO manage_sms_pattern(id,name,pattern_key,pattern_code,template,provider_setting_id,delay_in_min) values (9,'پترن کد ورود - فراز sms','FARAZ_SMS_PATTERN_SUPPORT_ANSWERED','rgmw67l84zc28y3','تیکت شما با شماره %support-id% در اپلیکیشن جیم پین پاسخ داده شد. با تشکر.',10,0);
