...
import com.notrika.gympin.common.place.parts.option.api.PlaceOptionController;
...
public class OptionControllerImpl implements PlaceOptionController {

    @Autowired
    private OptionService placeOptionService;
