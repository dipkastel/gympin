package com.notrika.gympin.controller.impl.purchased.purchasedAppointment;
...
@RestController
@RequestMapping("/api/v1/purchasedAppointment")
public class PurchasedAppointmentControllerImpl implements PurchasedSubscribeController {
    ...
    @Override
    @GetMapping("/getPlaceSellsSubscribesCount")
    public ResponseEntity<Long> getPlaceSellsSubscribesCount(Long placeId) {
        return ResponseEntity.ok(purchasedSubscribeService.getPlaceSellsSubscribesCount(placeId));
    }
