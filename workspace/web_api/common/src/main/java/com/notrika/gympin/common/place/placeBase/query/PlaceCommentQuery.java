package com.notrika.gympin.common.place.placeBase.query;
...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class PlaceCommentQuery extends BaseQuery<PlaceCommentQuery> {

    @JsonProperty("Status")
    private PlaceCommentStatusEnum is_status;
