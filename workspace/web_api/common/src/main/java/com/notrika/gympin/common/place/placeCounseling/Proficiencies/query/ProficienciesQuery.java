package com.notrika.gympin.common.place.placeCounseling.Proficiencies.query;
...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class ProficienciesQuery extends BaseQuery<ProficienciesQuery> {
    ...
    private Long min_proficiencyOfCounselingæid;
