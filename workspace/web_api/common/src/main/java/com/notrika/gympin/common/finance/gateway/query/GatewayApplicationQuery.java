package com.notrika.gympin.common.finance.gateway.query;
...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class GatewayApplicationQuery extends BaseQuery<GatewayApplicationQuery> {

    @JsonProperty("Application")
    private ApplicationEnum is_application;
