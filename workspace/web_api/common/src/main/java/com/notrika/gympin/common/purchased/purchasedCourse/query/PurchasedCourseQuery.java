package com.notrika.gympin.common.purchased.purchasedCourse.query;
...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class PurchasedCourseQuery extends BaseQuery<PurchasedCourseQuery> {


    @JsonProperty("Status")
    private SubscribePurchasedStatus is_status;

    @JsonProperty("TicketCourseId")
    private Long is_ticketCourseæid;

    @JsonProperty("PlaceId")
    private Long is_ticketCourseæplaceæid;

    @JsonProperty("UserId")
    private Long is_customeræid;

    @JsonProperty("TicketSubscribeName")
    private String like_ticketCourseName;
