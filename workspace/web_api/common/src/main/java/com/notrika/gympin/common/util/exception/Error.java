...
public class Error {
    ...
    public enum ErrorType {
        ...
        //subscribe
        SUBSCRIBE_NOT_FOUND(1301),
        SUBSCRIBE_EXPIRED(1302),
        SUBSCRIBE_NOT_PAYED(1303),
        SUBSCRIBE_CANCELED(1304),
        SUBSCRIBE_IS_IN_PROCESS(1305),
        SUBSCRIBE_USAGE_LIMIT(1306),
        ENTRY_ALREADY_EXIST(1307),
        SUBSCRIBE_IS_NOT_ACTIVE(1308),
        USER_REQUEST_ENTER(1309),
        SUBSCRIBE_OWNED_BY_OTHER_PLACE(1310),
        SUBSCRIBE_GENDER_IS_NOT_COMPATIBLE(1310),
        SUBSCRIBE_IS_ALREADY_PAYED(1311),
        SUBSCRIBE_PRICE_CONFLICT(1312),
        SUBSCRIBE_PRICE_TOTAL_CONFLICT(1313),
        SUBSCRIBE_PAY_BY_OTHERS(1314),
        SUBSCRIBE_FIRST_ENTRY_REQUEST_EXCEPTION(1315),
        //multimedia
        ...
        TICKET_SUBSCRIBE_CAPACITY_CANNOT_BE_NULL_OR_ZIRO(1602),
        TICKET_SUBSCRIBE_NAME_CANNOT_BE_NULL(1603),
        TICKET_SUBSCRIBE_EXPIRE_DATE_CANNOT_BE_NULL(1604),
        TICKET_SUBSCRIBE_EXPIRE_DURATION_CANNOT_BE_NULL(1605),
        TICKET_SUBSCRIBE_EXPIRE_TYPE_CANNOT_BE_NULL(1606),
        TICKET_SUBSCRIBE_DISCOUNT_CANNOT_BE_NULL(1607),
        TICKET_SUBSCRIBE_ENTRY_COUNT_CANNOT_BE_NULL_OR_ZIRO(1608),
        TICKET_SUBSCRIBE_GENDER_CANNOT_BE_NULL(1609),
        TICKET_SUBSCRIBE_PRICE_CANNOT_BE_NULL(1610),
        TICKET_SUBSCRIBE_SPORTS_CANNOT_BE_NULL(1611),
        TICKET_SUBSCRIBE_HALLS_CANNOT_BE_NULL(1612),
        TICKET_SUBSCRIBE_HAS_NOT_OWNER(1613),
        //place
