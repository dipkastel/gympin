package com.notrika.gympin.common.settings.location.query;
...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class LocationQuery extends BaseQuery<LocationQuery> {
    ...
    @JsonProperty("Type")
    private LocationType is_locationType;
