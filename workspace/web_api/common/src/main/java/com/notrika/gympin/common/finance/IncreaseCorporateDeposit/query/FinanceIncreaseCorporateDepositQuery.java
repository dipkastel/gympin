package com.notrika.gympin.common.finance.IncreaseCorporateDeposit.query;
...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class FinanceIncreaseCorporateDepositQuery extends BaseQuery<FinanceIncreaseCorporateDepositQuery> {
