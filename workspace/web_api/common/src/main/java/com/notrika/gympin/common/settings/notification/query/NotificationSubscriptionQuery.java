package com.notrika.gympin.common.settings.notification.query;
...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class NotificationSubscriptionQuery extends BaseQuery<NotificationSubscriptionQuery> {
