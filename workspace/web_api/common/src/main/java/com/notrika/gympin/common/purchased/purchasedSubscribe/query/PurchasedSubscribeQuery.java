...
@EqualsAndHashCode(callSuper = true)
    ...
    private Long max_id
    */
public class PurchasedSubscribeQuery extends BaseQuery<PurchasedSubscribeQuery> {
    ...
    private Long is_ticketSubscribeæplaceæid;

    @JsonProperty("UserId")
    private Long is_customeræid;

    @JsonProperty("TicketSubscribeName")
    private String like_ticketSubscribeName;
