...
interface AccountApi {
    ...
    @POST(NetworkConstants.account_refreshToken)
    fun userRefreshToken(@Body reqUserRefreshToken: Req_User_Refresh_Token): Flowable<Response<OprationResult<Res_Refresh_Token>>>
