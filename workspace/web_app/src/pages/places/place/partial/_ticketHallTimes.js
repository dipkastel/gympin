...
import {
    ticketSubscribe_getActiveTimesByTicketSubscribe
} from "../../../../network/api/ticketSubscribe.api";
import {dayOfWeekEnum} from "../../../../helper/enums/dayOfWeekEnum";

const _ticketHallTimes = ({subscribe}) => {
    const error = useContext(ErrorContext);
    const [openModalTimes,setOpenModalTimes]=useState()
...
export default _ticketHallTimes;
