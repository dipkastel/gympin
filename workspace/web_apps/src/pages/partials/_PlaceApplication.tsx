            ...
            <Card elevation={10} sx={{m:1.8,mt:6,borderRadius:8}}>
                <CardContent sx={{p:1,pt:4  }} >
                    ...
                    <Typography sx={{mx:2,mt:1,mb:5,direction:"rtl",fontSize:15,textAlign:"justify",lineHeight:"1.5em"}} variant={"subtitle1"}>
                        جیم پین برای مراکز ورزشی یک اپلیکیشن مخصوص دارد که در این اپلیکیشن، مجموعه های ورزشی امکاناتی مانند : بروز رسانی قیمت ها، ویرایش بلیط ها، بروز رسانی اطلاعات مجموعه را دارا می باشند. همچنین امکان اسکن بلیط، مشاهده بلیط های فروخته شده از دیگر امکانات این اپلیکیشن می باشد.
                    </Typography>
