...
export function Report_ticketBuyCountThisWeek(corporateId) {
  return axios.get(Api_url.report.ticketBuyCountThisWeek, {
    params: corporateId,
  });
}

export function Report_getGenderCompetition(corporateId) {
  return axios.get(Api_url.report.getGenderCompetition, {
    params: corporateId,
  });
}
...
export function Report_getActiveInEnterPlacePersonnel(corporateId) {
  return axios.get(Api_url.report.getActiveInEnterPlacePersonnel, {
    params: corporateId,
  });
}

export function Report_getBalanceChangedReport(corporateId) {
  return axios.get(Api_url.report.getBalanceChangedReport, {
    params: corporateId,
  });
}
...
export function Report_getPlaceViews(data) {
  return axios.post(Api_url.report.getPlaceViews, data);
}
