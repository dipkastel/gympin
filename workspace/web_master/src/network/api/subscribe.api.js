...
export function purchasedSubscribe_getPlaceSellsSubscribesCount(data) {
    return axios.get(Api_url.purchasedSubscribe.getPlaceSellsSubscribesCount, {params: data});
}
