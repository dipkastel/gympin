...
export function corporatePersonnel_corporateOwnedByUserId(data) {
  return axios.get(Api_url.CorporatePersonnel.corporateOwnedByUserId, {
    params: data,
  });
}
...
export function corporatePersonnel_ByCorporate(data) {
  return axios.get(Api_url.CorporatePersonnel.PersonnelByCorporate, {
    params: data,
  });
}
...
export function corporatePersonnel_setAllPersonelAccessToCatering(data) {
  return axios.post(
    Api_url.CorporatePersonnel.setAllPersonelAccessToCatering,
    data,
  );
}
export function corporatePersonnel_setPersonelAccessToCatering(data) {
  return axios.post(
    Api_url.CorporatePersonnel.setPersonelAccessToCatering,
    data,
  );
}
export function corporatePersonnel_getTotalUserCredits(data) {
  return axios.get(Api_url.CorporatePersonnel.getTotalUserCredits, {
    params: data,
  });
}
