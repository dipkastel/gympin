import { notifications_register } from "../network/api/notifications.api";
    ...
    .then(async (registration) => {
      ...
      async function subscribeAndSendToServer(registration) {
        const vapidPublicKey =
          "BCesZltGiWtG7RVkAl4qpoMigCmELNahwEyxQ5ivA-IcO93wF3-ERqA2ZqB2-UCYuDVZBiVYgotmaoYOdG9U6bw";
