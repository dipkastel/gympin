...
const _RChargeUsage = () => {
    ...
    function getUseplaceCharge(){
        setLoadStatus(LoadStatus.LOADING);
        if(!place)return;
        Report_useCorporateCharge({id:place?.Id}).then(result => {
    ...
    return (<>
            <BaseReportBox title={"میزان استفاده از شارژ سازمان "} loadStatus={loadStatus} ReloadData={()=>{getUseplaceCharge()}} >
