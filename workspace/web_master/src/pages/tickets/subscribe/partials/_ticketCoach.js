...
import {Avatar, Chip, CircularProgress, Dialog, DialogContent, DialogTitle, Rating, Typography} from "@mui/material";
...
const _ticketCoach = ({subscribe, reloadList}) => {
    ...
    function getTicketSubscribeCoaches() {
        TicketSubscribes_getCoaches({ticketId: subscribe.Id}).then(data => {
