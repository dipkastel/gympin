...
class regionManagement extends Component {
  ...
  getRegions() {
    location_getRegions_byCity({ Id: this.props.city.Id })
      .then((data) => {
        this.setState(() => ({
        ...
        <Modal show={regionToDelete} onHide={this.closeModalDelete}>
          ...
          <Modal.Footer>
            ...
            <Button
              ...
              onClick={(e) => this.deleteRegion(e, regionToDelete)}
            >
              حذف
            </Button>
          </Modal.Footer>
      ...
      <tr key={index}>
        ...
        <td>
          <Button
            ...
            color="primary"
            className={classes.button_edit}
            onClick={(e) => this.prepareEditRegion(e, region)}
          >
            ویرایش
          </Button>
          <Button
            ...
            color="primary"
            className={classes.button_danger}
            onClick={(e) => this.openModalDelete(e, region)}
          >
            حذف
          </Button>
        </td>
