...
class GateTransActions extends Component {
  constructor(props) {
    super(props);
    this.state = {
      addMode: false,
  ...
  render() {
    ...
    return (
      <>
        <Portlet>
          <PortletHeader
            title={"درامد " + this.props.place.Name}
            toolbar={
              <PortletHeaderToolbar>
                <button
                  type="button"
  ...
  getOwnersPlace() {
    location_getOwnersPlace({ Id: this.props.place.Id })
      .then((data) => {
        ...
        <Modal show={clientToDelete} onHide={this.closeModalDelete}>
          ...
          <Modal.Footer>
            ...
            <Button
              ...
              onClick={(e) => this.deleteRegion(e, clientToDelete)}
            >
              حذف
            </Button>
          </Modal.Footer>
      ...
      <tr key={index}>
        ...
        <td>
          <Button
            ...
            color="primary"
            className={classes.button_danger}
            onClick={(e) => this.openModalDelete(e, client)}
          >
            حذف
          </Button>
        </td>
...
export default withStyles(style)(GateTransActions);
