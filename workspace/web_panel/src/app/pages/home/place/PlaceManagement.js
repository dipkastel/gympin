...
class PlaceManagement extends Component {
    ...
    return (
      <>
        ...
        <Portlet>
          ...
          <PortletBody>
            <Paper className={"root"} hidden={!this.state.addMode}>
              <Form
                className={"container"}
                noValidate
                autoComplete="off"
              ...
              >
                <Form.Group controlId="formPlaceName">
                  <Form.Label>نام مرکز (مجموعه ورزشی)</Form.Label>
                  <Form.Control
                    name="formName"
                    type="text"
                  ...
                  <Form.Text className="text-muted">
                    از نوشتن هاشه ها (مجموعه ورزشی ، باشگاه ، استادیوم) خودداری
                    کنید
                  </Form.Text>
                </Form.Group>
                ...
                <Form.Group controlId="map">
                  <div id="kt_leaflet" className={"map"} />
                </Form.Group>
        ...
        {this.renderModalDelete(this.state.selectedPlaceToDelete)}
      </>
    );
  }
  componentDidMount() {
  ...
  getStates() {
    location_getAllState().then((data) => {
      ...
      this.setState(() => ({
        selectState: { options: statesOptions, selectedValue: null },
      }));
    });
  }
  deletePlace(e, place) {
        ...
        <td>
          <Stack direction="row" spacing={2}>
            <Button
              variant="contained"
              color="primary"
              href={"place/BaseData?placeId=" + place.Id}
            >
              مشخصات
            </Button>
            <Button
              variant="contained"
              color="primary"
              href={"place/detail?placeId=" + place.Id}
            >
              آمار و حساب ها
            </Button>
            <Button
              variant="contained"
              color="primary"
              onClick={(e) => this.prepareEditPlace(e, place)}
            >
              ویرایش
            </Button>
            <Button
              variant="contained"
              color="primary"
              onClick={(e) => this.openModalDelete(e, place)}
            >
              حذف
            </Button>
          </Stack>
  ...
  renderModalDelete = (placeToDelete) => {
    return (
      <>
        <Modal show={placeToDelete} onHide={this.closeModalDelete}>
          ...
          <Modal.Footer>
            <Button className={"button_edit"} onClick={this.closeModalDelete}>
              خیر
            </Button>
            <Button
              className={"button_danger"}
              onClick={(e) => this.deletePlace(e, placeToDelete)}
            >
              حذف
            </Button>
          </Modal.Footer>
