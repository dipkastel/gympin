...
const mapStateToProps = (store) => ({
  ...
  asideMenuAttr: builderSelectors.getAttributes(store, { path: "aside_menu" }),
  disableAsideSelfDisplay:
    builderSelectors.getConfig(store, "aside.self.display") === false,

  ulClasses: builderSelectors.getClasses(store, {
    path: "aside_menu_nav",
    toString: true,
  }),

  asideClassesFromConfig: builderSelectors.getClasses(store, {
    path: "aside_menu",
    toString: true,
  }),
});
