...
const mapStateToProps = (store) => ({
  ...
  ktMenuClasses: builderSelectors.getClasses(store, {
    path: "header_menu",
    toString: true,
  }),
  rootArrowEnabled: builderSelectors.getConfig(
    store,
    "header.menu.self.root-arrow"
  ),
  headerSelfSkin: builderSelectors.getConfig(store, "header.self.skin"),
