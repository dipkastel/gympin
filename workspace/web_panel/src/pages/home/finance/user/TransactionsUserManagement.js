...
const TransactionsUserManagement = () => {
    const history = useHistory();
    const [page, setPage] = useState(0);
    const [rowsPerPage, setRowsPerPage] = useState(getRppTransactionUserManagement());
    ...
    return (
        <>
            ...
            <Portlet>
                <PortletHeader title="تراکنش های کاربران" />
                <PortletBody>
                    <TableContainer>
                        <Table
                            sx={{minWidth: 750}}
                    ...
                    {(transactions.totalElements > 0) && <TablePagination
                        ...
                        onRowsPerPageChange={(event) => {
                            ...
                            SetRppTransactionUserManagement(parseInt(event.target.value, 10));
                            setPage(0);
                        }}
                    />}
                </PortletBody>
...
export default TransactionsUserManagement;
