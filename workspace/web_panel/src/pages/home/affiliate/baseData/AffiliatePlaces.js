...
const AffiliateCorporates = ({affiliateId}) => {
    ...
    function getPlaces() {
        affiliate_getPlacesByAffiliatorId({id: affiliateId}).then((result) => {
                ...
                <Modal show={openModalAdd} onHide={() => setOpenModalAdd(false)}>
                    <Form
                        ...
                        <Modal.Header closeButton>
                            <Modal.Title>{"افزودن مرکز به همکار فروش"}</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <__SelectPlace onChange={(e) => {
                                setSelectedPlaceId(e.value)
                            }}/>
                        </Modal.Body>
                        <Modal.Footer>
                            <Button
                            ...
                            >
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell align="right" padding="normal" sortDirection={false}>نام مرکز</TableCell>
                                        <TableCell align="left" padding="normal" sortDirection={false}>action</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {placeList.map((row, index) => {
