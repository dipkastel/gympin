...
import {pages_add, pages_delete, pages_query} from "../../../network/api/pages.api";
...
const PageList = () => {
    ...
    function RenderModalAdd() {
        function addPlace(e) {
            e.preventDefault()
            pages_add({Title:e.target.PageName.value,Description:e.target.pageDescription.value,Parent:{Id:1}})
                .then((data) => {
                    history.push({
    ...
    function RenderModalDelete() {
        ...
        function DeleteItem(e) {
            e.preventDefault()
            pages_delete({Id:itemToDelete.Id}).then((data) => {
