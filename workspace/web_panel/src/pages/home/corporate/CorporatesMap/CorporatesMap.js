...
const CorporatesMap = () => {
    ...
    const [corporateStatus, setCorporateStatus] = useState(null);
    ...
    function addMarkers(corporates) {
        corporates.forEach(corporate => {
            if (corporate.Latitude != null && corporate.Longitude != null){
                addMarker(corporate);
            }
        });
    }
    ...
    function addMarker(corporate) {
        ...
        // markerl.clearLayers();
        let marker = L.marker([corporate.Latitude, corporate.Longitude], {icon: leafletIcon, title: corporate.Name});
        marker.on('click', function (e) {
            history.push({pathname: "/corporate/details/" + corporate.Id});
        });
        if(markerLayer)
                            ...
                            <Select
                                    ...
                                    value={
                                        getStatusOptions().filter(option =>
                                            option.value === corporateStatus)
                                    }
                                    options={getStatusOptions()}
                                    onChange={(e) => setCorporateStatus( e.value)}
                                />
                        </PortletHeaderToolbar>
                        }
