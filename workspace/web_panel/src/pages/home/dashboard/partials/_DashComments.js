...
import {Check, Close, Message, Reviews} from "@mui/icons-material";
...
const _DashSupport = () => {
    ...
    return (<>
        <QuickStatsIcon
            ...
            title="نظرات"
            text={Comment.totalElements > 0 ? "شما " + Comment.totalElements + " نظر تایید نشده دارید" : "تمام نظرات بررسی شده"}
            icon={<Reviews sx={{fontSize: 40, color: Comment.totalElements > 0 ? "#d00d48" : "#0c5049"}}
                           color={"#AA5598"}/>}
        />
        {renderModalSupport()}
    </>)
