...
const _DashOldPricesTickets = () => {
    ...
    return (<>
        <QuickStatsIcon
            ...
            text={Comment.totalElements > 0 ? Comment.totalElements + " بلیط بیش از 90 روز تغییر نکرده" : "تمام بلیط ها به روز شده"}
            icon={<Explore sx={{fontSize: 40, color: Comment.totalElements > 0 ? "#d00d48" : "#0c5049"}}
                           color={"#AA5598"}/>}
        />
        {renderModalSupport()}
    </>)
...
export default _DashOldPricesTickets;
