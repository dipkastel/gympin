...
const CounselingsManagement = () => {
    ...
    function RenderModalAdd() {
        function addPlace(e) {
            ...
            PlaceCounseling_addPlace({Address: "", Name: e.target.formName.value , Region: {Id: 1}})
                .then((data) => {
                    error.showError({message: "عملیات موفق",});
                    history.push({
                        pathname: "/gyms/data/" + data.data.Data.Id
                    });
                })
                .catch(e => {
                    try {
...
export default CounselingsManagement;
