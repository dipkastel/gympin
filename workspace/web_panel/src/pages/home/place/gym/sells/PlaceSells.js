                    ...
                    <Table className={"table"}>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell align="right">بلیط</TableCell>
                                <TableCell align="right">قیمت</TableCell>
                                <TableCell align="right">نوع / جنسیت</TableCell>
                                <TableCell align="right">تاریخ فروش</TableCell>
                            ...
                            {buyables.content && buyables.content.map((item, number) => (
                                <TableRow hover role={"checkbox"} tabIndex={-1}
                                    ...
                                    <TableCell align="right">
                                        <ListItemText
                                            primary={"فروش : "+toPriceWithComma(item.SellPrice)}
                                            secondary={"مرکز : "+toPriceWithComma(item.PlacePrice)}
                                        />
                                    </TableCell>
                                    <TableCell align="right">{BuyableType[item.PurchasedType]+" / "+genders[item.Gender]}</TableCell>
                                    <TableCell align="right">{new Date(item?.Serial?.[0]?.CreatedDate).toLocaleDateString('fa-IR', {
                                        year: 'numeric',
                                        month: 'long',
                                        day: 'numeric',
                                        hour: "2-digit",
                                    ...
                                    <TableCell align="left"><Chip color={getStatusCollor(item)} size={"small"} label={[item.PurchasedStatus]}/></TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
