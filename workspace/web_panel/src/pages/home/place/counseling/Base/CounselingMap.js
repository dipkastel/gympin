...
class CounselingMap extends Component {


    constructor(props) {
        super(props);
        this.state = {
            selectedLat: props.counseling.Latitude==0?tehranCenterLat:props.counseling.Latitude,
            selectedLng: props.counseling.Longitude==0?tehranCenterLong:props.counseling.Longitude
        };
    }
    componentDidMount() {
        this.prepareMap();
