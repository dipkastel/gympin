...
import {placeCounseling_getBuyableByPlace} from "../../../../../network/api/Counseling.api";

const CounselingBeneficiaries = ({counseling}) => {
    ...
    function getAllBuyables(){
        placeCounseling_getBuyableByPlace({Id:counseling.Id}).then(data=>{
            SetBuyables(data.data.Data);
            getBeneficiaries();
        }).catch(e => {
                    try {
    ...
    function getBeneficiaries(){
        placePersonnel_ByPlace({Id:counseling.Id}).then(result=>{
            ...
            <Portlet>
                ...
                <PortletBody>
                    ...
                    <Table className={"table"}>
                        ...
                        <TableBody>
                            {beneficiaries&&buyables&&buyables.map(row => (
                                <TableRow key={row.Id}>
...
export default CounselingBeneficiaries;
