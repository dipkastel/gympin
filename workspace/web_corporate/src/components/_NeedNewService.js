                ...
                <Form onSubmit={(e) => submitRequest(e)}>
                    ...
                    <DialogContent>
                        <Typography sx={{textAlign:"justify",mb:2}} variant={"subtitle2"}>
                            ما در جیم پین آماده‌ایم تا خدمات مورد نیاز شما را متناسب با سازمان‌تان ارائه دهیم. اگر خدماتی مد نظر دارید، با ما در میان بگذارید؛ لطفاً بدون نگرانی از محدودیت‌ها، درخواست خود را ثبت کنید و بررسی و اجرای آن را به تیم حرفه‌ای ما بسپارید.
                        </Typography>
                        <TextField
                            autoFocus
                            margin="dense"
        ...
        <>
            ...
            <Card sx={{mt: -8, mb: 2, mx: 2}} elevation={10}>
                <CardActionArea
                    ...
                    <Typography sx={{mb: 1,mt:4, width: "100%", textAlign: "justify",lineHeight:"1.5rem"}} color={"info"} variant={"body2"}>
                        در صورتی که درخواستی دارید، تیم ما آماده‌ی ارائه خدمات به شما است. کافی است درخواست خود را ثبت کنید تا در اسرع وقت پیگیری‌های لازم انجام شود.
                    </Typography>
                    <Button variant={"contained"} size={"large"} sx={{py:1,px:8}}>درخواست شما</Button>
                </CardActionArea>
            </Card>
            {renderModalAdd()}
        </>
